...
Print assembled.
*/    
echo "My name is" . " ". $fname ." ". $lname . "." . " ". "I was born on " . $day ." of ". $month . " in " . $year . ".";
...
$length = 6.5;
$width = 3.5;
echo "$length x $width = ". $length * $width;
...
$tax = 0.13;
$delivery = 0.05;
$equation = $price + $price * $tax + ($price + $price * $tax) * $delivery;


echo $product .": ". "$" . number_format ($equation, 2);
...
<figure>
  <img src="https://placehold.jp/24/e8d2ae/fff/300x300.png" alt="placeholder-image">
  <figcaption> <?php echo $product .": ". "$" . number_format ($equation, 2);?>
 </figcaption>
</figure>
</html>